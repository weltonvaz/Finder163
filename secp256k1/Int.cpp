...
/* by Trindade */
void Int::SetLower24Bytes(uint64_t *numbers){
    uint64_t *ptr = (uint64_t *)numbers;
    bits64[2] = _byteswap_uint64(ptr[0]);
    bits64[1] = _byteswap_uint64(ptr[1]);
    bits64[0] = _byteswap_uint64(ptr[2]);
}
